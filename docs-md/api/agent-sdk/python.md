...
| `rewind_files(user_message_uuid)` | Restore files to their state at the specified user message. Requires `enable_file_checkpointing=True`. See [File checkpointing](agent-sdk/file-checkpointing.md) |
...
- `input_data`: Hook-specific input data (see [Hooks guide](agent-sdk/hooks.md))
