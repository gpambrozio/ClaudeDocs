...
**Discovering tool names:** See [Tool Input Types](agent-sdk/typescript.md) for the full list of built-in tool names, or add a hook without a matcher to log all tool calls your session makes.
