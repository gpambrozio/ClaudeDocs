...
The SDK also supports [programmatic sandbox configuration](agent-sdk/typescript.md) for command execution.
...
For self-hosted options (Docker, gVisor, Firecracker) and detailed isolation configuration, see [Isolation Technologies](agent-sdk/secure-deployment.md).
...
- [TypeScript SDK - Sandbox Settings](agent-sdk/typescript.md) - Configure sandbox programmatically
