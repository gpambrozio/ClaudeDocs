...
The API keeps the option to disable thinking, subject to the [effort restriction](models/opus-5/whats-new-opus-5.md) on disabling it.
...
Thinking is [on by default](models/opus-5/whats-new-opus-5.md) on Claude Opus 5, so no `thinking` field is needed.
