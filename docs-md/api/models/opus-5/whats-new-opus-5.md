...
Claude Opus 5.5 is the current Opus model. See [What's new in Claude Opus 5.5](../opus-5-5/whats-new-opus-5-5.md).
...
The API keeps the option to disable thinking, subject to the [effort restriction](whats-new-opus-5.md#disabling-thinking-requires-effort-high-or-below) on disabling it.
...
Thinking is [on by default](whats-new-opus-5.md#thinking-on-by-default) on Claude Opus 5, so no `thinking` field is needed.
...
Compared with Claude Opus 4.8, Claude Opus 5 is a step-change improvement rather than an incremental one, and it delivers frontier intelligence at half the cost of [Claude Fable 5](../fable-5/introducing-claude-fable-5-and-claude-mythos-5.md). The largest gains are in:
...
For the prompting patterns that get the most out of these capabilities, see [Prompting Claude Opus 5](../../build-with-claude/prompt-engineering/prompting-claude-opus-5.md#capability-improvements).
