...
Claude Fable 5.1 and Claude Mythos 5.1 build on these models. See [What's new in Claude Fable 5.1](../fable-5-1/whats-new-fable-5-1.md).
...
For specs across all current models, see the [models overview](../overview.md).
...
* **Server-side:** Pass the `fallbacks` parameter to have the API retry for you, using its `"default"` mode for Anthropic's recommended models or naming your own (in beta on the Claude API). See [Server-side fallback](../../build-with-claude/refusals-and-fallback.md#server-side-fallback).
* **Client-side:** Use the [SDK middleware](../../cli-sdks-libraries/middleware.md) to retry from the client on any platform. See [Client-side fallback](../../build-with-claude/refusals-and-fallback.md#client-side-fallback).
...
* **Claude Fable 5** is available on the Claude API, [Amazon Bedrock](../../build-with-claude/claude-in-amazon-bedrock.md), [Claude Platform on AWS](../../build-with-claude/claude-platform-on-aws.md), [Google Cloud](../../build-with-claude/claude-on-vertex-ai.md), and [Microsoft Foundry](../../build-with-claude/claude-in-microsoft-foundry.md).
...
Pass thinking blocks back unchanged in multi-turn conversations on the same model. See [thinking output on Claude Fable 5 and Claude Mythos 5](../../build-with-claude/thinking.md#thinking-output-on-claude-fable-5-and-claude-mythos-5) for cross-model handling.
...
* From Claude Mythos Preview: see [Migrating from Claude Mythos Preview to Claude Mythos 5](migration-guide.md#migrating-from-claude-mythos-preview).
* From Claude Opus 4.8: see [Migrating from Claude Opus 4.8 to Claude Fable 5](migration-guide.md#migrating-from-claude-opus-48).
