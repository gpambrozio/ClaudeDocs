...
Although Claude Opus 4.6 is still available, you should consider migrating to Claude Opus 5 for improved performance. [See Claude Opus 5](../opus-5/overview.md) · [Migrate to Claude Opus 5](../opus-5/migration-guide.md#migrating-from-claude-opus-46)
