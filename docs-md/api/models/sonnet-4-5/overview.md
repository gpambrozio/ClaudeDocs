...
Although Claude Sonnet 4.5 is still available, you should consider migrating to Claude Sonnet 5 for improved performance. [See Claude Sonnet 5](models/sonnet-5/overview.md) · [Migrate to Claude Sonnet 5](models/sonnet-5/migration-guide.md)
