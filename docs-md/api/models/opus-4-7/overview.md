...
description: "Claude Opus 4.7 reference: lifecycle status, model IDs on every platform, context window, output limits, pricing, and migration resources. Claude Opus 4.7 is a legacy model; Claude Opus 5.5 is the current Opus model."
---

**Legacy.** Released April 16, 2026.

Although Claude Opus 4.7 is still available, you should consider migrating to Claude Opus 5.5 for improved performance. [See Claude Opus 5.5](../opus-5-5/overview.md) · [Migrate to Claude Opus 5.5](../opus-5-5/migration-guide.md#migrating-from-claude-opus-47)
...
| [Amazon Bedrock](../../build-with-claude/claude-in-amazon-bedrock.md)       | `anthropic.claude-opus-4-7` |
| [Google Cloud](../../build-with-claude/claude-on-vertex-ai.md)              | `claude-opus-4-7`           |
| [Microsoft Foundry](../../build-with-claude/claude-in-microsoft-foundry.md) | `claude-opus-4-7`           |
| [Claude Platform on AWS](../../build-with-claude/claude-platform-on-aws.md) | `claude-opus-4-7`           |
...
What changes when moving from Claude Opus 4.7 to Claude Opus 5.5.
