...
For behavioral differences and model-specific prompting patterns, see [Prompting Claude Opus 5.5](../../build-with-claude/prompt-engineering/prompting-claude-opus-5-5.md).

Claude Opus 5.5 costs less than Claude Opus 5 ($4 / $20 USD per million input / output tokens, compared with $5 / $25; see [Claude pricing](../../about-claude/pricing.md)), and keeps Claude Opus 5's [1M token context window](../../build-with-claude/context-windows.md) and 128k max output tokens. There are four breaking changes for code already running on Claude Opus 5, covered under [Breaking changes](migration-guide.md#breaking-changes). For feature support, see [What's new in Claude Opus 5.5](whats-new-opus-5-5.md#feature-support).
