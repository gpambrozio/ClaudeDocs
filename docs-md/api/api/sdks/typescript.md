...
- [Microsoft Azure / Foundry](build-with-claude/claude-in-microsoft-foundry.md)
...
For information on using Claude through Microsoft Azure and Azure AI Foundry, see [Claude in Microsoft Foundry](build-with-claude/claude-in-microsoft-foundry.md).
