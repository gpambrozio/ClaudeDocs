...
This SDK provides support for tool use, also known as function calling. More details can be found in the [tool use overview](agents-and-tools/tool-use/overview.md).
...
> For more information on debugging requests, see the [errors documentation](api/errors.md).
