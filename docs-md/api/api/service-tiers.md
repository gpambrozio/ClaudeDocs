...
- For [US-only inference](manage-claude/data-residency.md) (`inference_geo: "us"`) requests on Claude Opus 4.6, Claude Sonnet 4.6, and later models, input tokens are 1.1 tokens per token
- All other input tokens are 1 token per token

**Output tokens**

- For [US-only inference](manage-claude/data-residency.md) (`inference_geo: "us"`) requests on Claude Opus 4.6, Claude Sonnet 4.6, and later models, output tokens are 1.1 tokens per token
...
Check the [Models overview](about-claude/models/overview.md) for more details on available models.
