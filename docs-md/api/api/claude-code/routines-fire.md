...
| `anthropic-version` | Yes                  | The [API version](../versioning.md). `2023-06-01` is the only accepted value. |
...
| ----------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 400         | `invalid_request_error` | Missing or unsupported `anthropic-version` header, `text` exceeds 65,536 characters, or the routine is paused (see [Edit and control routines](../../../claude-code/routines.md#edit-and-control-routines)). |
...
To learn how routine usage interacts with subscription limits and extra usage billing, see [Usage and limits](../../../claude-code/routines.md#usage-and-limits) in the Claude Code documentation.
