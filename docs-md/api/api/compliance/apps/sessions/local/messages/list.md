...
data: array of object{ id, content, created\_at, 4 more }
...
defaultcompliance\_local\_session\_message
...
session: object{ id, created\_at, organization\_uuid, 5 more }
