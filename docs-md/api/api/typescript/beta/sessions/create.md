...
agent: string | [BetaManagedAgentsAgentParams](api/beta/sessions.md) { id, type, version }  | [BetaManagedAgentsAgentWithOverridesParams](api/beta/sessions.md) { id, type, mcp\_servers, 5 more } 
