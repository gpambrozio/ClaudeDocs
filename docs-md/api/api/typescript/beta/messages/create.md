...
MessageCreateParamsBase { max\_tokens, messages, model, 17 more }
...
MessageCreateParamsNonStreaming extends MessageCreateParamsBase { max\_tokens, messages, model, 17 more }  { stream }
