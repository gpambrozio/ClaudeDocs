...
BetaSelfHostedWork { id, acknowledged\_at, created\_at, 10 more } 
...
data: Array<[BetaSelfHostedWork](api/beta/environments/work.md) { id, acknowledged\_at, created\_at, 10 more } >
