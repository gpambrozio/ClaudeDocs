...
data: optional array of [BetaManagedAgentsSessionThread](api/http/beta/sessions/threads.md) { id, agent, archived\_at, 8 more }
...
stats: [BetaManagedAgentsSessionThreadStats](api/http/beta/sessions/threads.md) { active\_seconds, duration\_seconds, startup\_seconds } or null
...
status: [BetaManagedAgentsSessionThreadStatus](api/http/beta/sessions/threads.md)
...
usage: [BetaManagedAgentsSessionThreadUsage](api/http/beta/sessions/threads.md) { active\_seconds, cache\_creation, cache\_read\_input\_tokens, 4 more } or null
