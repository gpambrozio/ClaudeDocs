...
data: array of [BetaAPIKey](api/http/beta/organization/api_keys.md) { id, created\_at, created\_by, 8 more }
...
created\_by: [BetaAPIKeyCreatedBy](api/http/beta/organization/api_keys.md) { id, type } or null
...
principal: [BetaAPIKeyUserActor](api/http/beta/organization/api_keys.md) { type, user\_id } or [BetaAPIKeyServiceAccountActor](api/http/beta/organization/api_keys.md) { service\_account\_id, type } or null
...
scope: [BetaAPIKeyOrganizationScope](api/http/beta/organization/api_keys.md) { type } or [BetaAPIKeyWorkspaceScope](api/http/beta/organization/api_keys.md) { type, workspace\_id }
