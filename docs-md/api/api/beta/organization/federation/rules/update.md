...
match: optional [BetaFederationRuleMatch](api/http/beta/organization/federation/rules.md) { audience, claims, condition, subject\_prefix } or null
...
target: optional [BetaServiceAccountTarget](api/http/beta/organization/federation/rules.md) { service\_account\_id, type, service\_account\_name } or null
