...
BetaManagedAgentsAgentToolConfig = [BetaManagedAgentsBashToolConfig](api/beta/agents.md) { enabled, name, permission\_policy, type }  or [BetaManagedAgentsEditToolConfig](api/beta/agents.md) { enabled, name, permission\_policy, type }  or [BetaManagedAgentsReadToolConfig](api/beta/agents.md) { enabled, name, permission\_policy, type }  or 5 more
...
BetaManagedAgentsAgentToolConfigParams = [BetaManagedAgentsBashToolConfigParams](api/beta/agents.md) { name, enabled, permission\_policy, type }  or [BetaManagedAgentsEditToolConfigParams](api/beta/agents.md) { name, enabled, permission\_policy, type }  or [BetaManagedAgentsReadToolConfigParams](api/beta/agents.md) { name, enabled, permission\_policy, type }  or 5 more
...
BetaManagedAgentsSkillParams = [BetaManagedAgentsAnthropicSkillParams](api/beta/agents.md) { skill\_id, type, version }  or [BetaManagedAgentsCustomSkillParams](api/beta/agents.md) { skill\_id, type, version } 
