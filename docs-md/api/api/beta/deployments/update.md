...
initial\_events: optional array of [BetaManagedAgentsDeploymentInitialEventParams](api/beta.md)
...
schedule: optional [BetaManagedAgentsScheduleParams](api/beta.md) { expression, timezone, type }
