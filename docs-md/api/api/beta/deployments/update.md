...
agent: optional string or [BetaManagedAgentsAgentParams](api/http/beta/sessions.md) { id, type, version }
...
initial\_events: optional array of [BetaManagedAgentsDeploymentInitialEventParams](api/http/beta/deployments.md)
