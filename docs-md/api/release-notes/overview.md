...
- [Fine-grained tool streaming](agents-and-tools/tool-use/fine-grained-tool-streaming.md) is now generally available on all models and platforms (no beta header required).
...
- [Tool use](agents-and-tools/tool-use/overview.md) is now generally available across the Claude API, Amazon Bedrock, and Vertex AI.
