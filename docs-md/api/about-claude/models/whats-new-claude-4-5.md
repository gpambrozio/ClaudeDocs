...
This is the first Haiku model with native context awareness capabilities. For prompting guidance, see [Claude 4 best practices](build-with-claude/prompt-engineering/claude-4-best-practices.md).
...
Available in Claude Opus 4.5 and Claude Sonnet 4.5. Requires [beta header](api/beta-headers.md): `advanced-tool-use-2025-11-20`
...
Available exclusively in Claude Opus 4.5. Requires [beta header](api/beta-headers.md): `effort-2025-11-24`

### Tool use examples (Beta)

[Tool use examples](agents-and-tools/tool-use/implement-tool-use.md) allow you to provide concrete examples of valid tool inputs to help Claude understand how to use your tools more effectively. This is particularly useful for complex tools with nested objects, optional parameters, or format-sensitive inputs.
...
Available in Claude Sonnet 4.5, Haiku 4.5, Opus 4.5, Opus 4.1, and Opus 4. Requires [beta header](api/beta-headers.md): `advanced-tool-use-2025-11-20`.
...
Available in Claude Sonnet 4, Sonnet 4.5, Haiku 4.5, Opus 4, Opus 4.1, and Opus 4.5. Requires [beta header](api/beta-headers.md): `context-management-2025-06-27`
...
For more information, see the [Extended thinking documentation](build-with-claude/extended-thinking.md).
...
For migration instructions, see the [Code execution tool documentation](agents-and-tools/tool-use/code-execution-tool.md).
...
Learn prompt engineering techniques for Claude 4.5 models](build-with-claude/prompt-engineering/claude-4-best-practices.md)[Model overview
