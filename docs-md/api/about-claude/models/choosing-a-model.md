...
- **Speed:** How quickly does the model need to respond in your application? For Claude Opus 4.6, [fast mode](build-with-claude/fast-mode.md) (beta: research preview) can provide up to 2.5x higher output speed at premium pricing.
...
See detailed specifications and pricing for the latest Claude models](about-claude/models/overview.md)[What's new in Claude Opus 4.7

Explore the latest improvements in Claude Opus 4.7](about-claude/models/whats-new-claude-4-7.md)[Start building
