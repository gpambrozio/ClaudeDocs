...
When using Claude Sonnet 4 or Sonnet 4.5 with the [1M token context window enabled](build-with-claude/context-windows.md), requests that exceed 200K input tokens are automatically charged at premium long context rates:
