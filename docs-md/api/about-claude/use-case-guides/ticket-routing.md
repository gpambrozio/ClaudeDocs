...
Work with your support team to [define clear success criteria](test-and-evaluate/define-success.md) with measurable benchmarks, thresholds, and goals.
...
To run your evaluation, you will need test cases to run it on. The rest of this guide assumes you have already [developed your test cases](test-and-evaluate/develop-tests.md).
