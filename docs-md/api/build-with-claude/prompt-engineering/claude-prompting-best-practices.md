...
For an overview of model capabilities, see the [models overview](about-claude/models/overview.md). For details on what's new in Claude 4.6, see [What's new in Claude 4.6](about-claude/models/whats-new-claude-4-6.md). For migration guidance, see the [Migration guide](about-claude/models/migration-guide.md).
...
The extended thinking paths above use `budget_tokens` for predictable token usage. If your workload fits one of the following patterns, consider trying [adaptive thinking](build-with-claude/adaptive-thinking.md) instead:
