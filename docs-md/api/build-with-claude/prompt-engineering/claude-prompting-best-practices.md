...
4. **Update thinking configuration**: Claude Opus 4.6 uses [adaptive thinking](build-with-claude/adaptive-thinking.md) (`thinking: {type: "adaptive"}`) instead of manual thinking with `budget_tokens`. Use the [effort parameter](build-with-claude/effort.md) to control thinking depth.
