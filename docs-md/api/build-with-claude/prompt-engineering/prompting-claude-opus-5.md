...
This guide covers the prompting patterns specific to Claude Opus 5. For the model's specifications, see [Claude Opus 5](../../models/opus-5/overview.md). For techniques that apply across all current Claude models, see [Prompting best practices](claude-prompting-best-practices.md).
