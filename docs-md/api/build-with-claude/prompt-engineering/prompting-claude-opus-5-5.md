...
* You run a team of agents and want it to finish sooner: [Time signals for multiagent harnesses](prompting-claude-opus-5-5.md#time-signals-for-multi-agent-harnesses)
