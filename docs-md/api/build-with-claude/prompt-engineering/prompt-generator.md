...
The prompt generator is compatible with all Claude models, including those with extended thinking capabilities. For prompting tips specific to extended thinking models, see the [extended thinking documentation](build-with-claude/extended-thinking.md).
...
Get inspired by a curated selection of prompts for various tasks and use cases.](build-with-claude/prompt-engineering/be-clear-and-direct.md)[Prompt library
