...
Claude on Foundry supports most of Claude's powerful features. You can find all the features currently supported in the [overview documentation](build-with-claude/overview.md).

### Context window

Claude Opus 4.6, Sonnet 4.6, and Sonnet 4.5 have a [1M-token context window](build-with-claude/context-windows.md) on Microsoft Foundry.

For Claude Sonnet 4.5, the 1M-token context window is in beta. To use, include the `context-1m-2025-08-07` [beta header](api/beta-headers.md) in your API requests.
