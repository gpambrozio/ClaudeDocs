...
Claude Opus 4.6 and Sonnet 4.6 have a [1M-token context window](build-with-claude/context-windows.md) on Microsoft Foundry. Other Claude models, including Sonnet 4.5, have a 200k-token context window.
