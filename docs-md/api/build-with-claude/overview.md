...
| [Adaptive thinking](build-with-claude/thinking-steering-and-cost.md) | Let Claude dynamically decide when and how much to think. The only [thinking](build-with-claude/thinking.md) mode on Claude Opus 4.8, Claude Opus 4.7, Claude Sonnet 5, Claude Fable 5, and Claude Mythos 5. Use the effort parameter to control thinking depth. | ZDR eligible | Claude API (GA)  Bedrock (GA)  Claude Platform on AWS (GA)  Google Cloud (GA)  Microsoft Foundry (GA) |
