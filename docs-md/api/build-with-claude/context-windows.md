...
For more information about using tools with extended thinking, see our [extended thinking guide](build-with-claude/extended-thinking.md).
...
For prompting guidance on leveraging context awareness, see our [Claude 4 best practices guide](build-with-claude/prompt-engineering/claude-4-best-practices.md).
...
See our [model comparison](about-claude/models/overview.md) table for a list of context window sizes by model.
