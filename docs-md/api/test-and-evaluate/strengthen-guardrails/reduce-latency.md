...
For a more in-depth understanding of these terms, check out the [glossary](../../about-claude/glossary.md).
...
* **Ask for shorter responses:** Ask Claude directly to be concise. If Claude is outputting unwanted length, ask Claude to [curb its chattiness](../../build-with-claude/prompt-engineering/claude-prompting-best-practices.md#be-clear-and-direct).
  Because of how LLMs count 

  [tokens](../../about-claude/glossary.md#tokens)
