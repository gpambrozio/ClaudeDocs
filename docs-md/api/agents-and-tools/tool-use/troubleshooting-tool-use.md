...
| --- | --- | --- |
| Claude calls tool A when you wanted tool B | Description ambiguity | Sharpen descriptions. Differentiate tools by WHEN to use them, not only WHAT they do. See [Define tools](agents-and-tools/tool-use/define-tools.md). |
...
See [Thinking blocks cannot be modified](api/errors.md) for the full error and fix steps.
