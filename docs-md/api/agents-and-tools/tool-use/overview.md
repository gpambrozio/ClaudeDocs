...
Here's a minimal example using a server tool, the [Web search tool](web-search-tool.md), which Anthropic executes for you:
...
To connect to Model Context Protocol (MCP) servers, see the [MCP connector](../mcp-connector.md). To build your own MCP client, see the Model Context Protocol guide to [building an MCP client](https://modelcontextprotocol.io/docs/develop/build-client).
...
To require a tool call rather than rely on prompting, set [`tool_choice`](define-tools.md#forcing-tool-use).

**Guarantee schema conformance with strict tool use**

Add `strict: true` to your custom tool definitions to ensure Claude's tool calls always match your schema exactly. See [Strict tool use](strict-tool-use.md).
...
For `type` strings, versions, and beta headers, see [Tool reference](tool-reference.md).
...
Server tools run on Anthropic's infrastructure, with no handler code in your application. See [Server tools](server-tools.md) for the mechanics they share.
...
| Claude Opus 4.1 ([retired, except on Bedrock and Google Cloud](../../about-claude/model-deprecations.md))  | 313 tokens                                | 315 tokens                               |
| Claude Opus 4 ([retired, except on Google Cloud](../../about-claude/model-deprecations.md))                | 313 tokens                                | 315 tokens                               |
| Claude Sonnet 5                                                                                                                       | 354 tokens                                | 474 tokens                               |
| Claude Sonnet 4.6                                                                                                                     | 497 tokens                                | 589 tokens                               |
| Claude Sonnet 4.5                                                                                                                     | 496 tokens                                | 588 tokens                               |
| Claude Sonnet 4 ([retired, except on Bedrock and Google Cloud](../../about-claude/model-deprecations.md))  | 313 tokens                                | 315 tokens                               |
| Claude Haiku 4.5                                                                                                                      | 496 tokens                                | 588 tokens                               |
| Claude Haiku 3.5 ([retired, except on Bedrock and Google Cloud](../../about-claude/model-deprecations.md)) | 264 tokens                                | 355 tokens                               |
...
See the [Models overview](../../models/overview.md#latest-models-comparison) table for current per-model prices.
...
Some server tools add usage-based charges on top of tokens: see [Web search tool](web-search-tool.md#usage-and-pricing) and [Code execution tool](code-execution-tool.md#usage-and-pricing) for their rates.
