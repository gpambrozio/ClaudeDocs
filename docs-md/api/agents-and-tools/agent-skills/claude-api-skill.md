...
* **Model migration:** Step-by-step guidance for migrating to newer Claude models (including the breaking changes and behavior shifts on [Claude Opus 5.5](../../models/opus-5-5/migration-guide.md#migrating-from-claude-opus-5) and [Claude Fable 5.1](../../models/fable-5-1/migration-guide.md))
...
For the full list of model-specific changes the skill applies, see [Migrating to Claude Opus 5.5 from Claude Opus 5](../../models/opus-5-5/migration-guide.md#migrating-from-claude-opus-5), [Migrating to Claude Opus 5.5 from Claude Opus 4.8](../../models/opus-5-5/migration-guide.md#migrating-from-claude-opus-4-8), and [Migrating to Claude Fable 5.1](../../models/fable-5-1/migration-guide.md).
