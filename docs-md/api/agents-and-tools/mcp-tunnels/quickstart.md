...
- A role in the [Claude Console](https://console.anthropic.com) that can manage MCP tunnels. See the [Console guide prerequisites](agents-and-tools/mcp-tunnels/console.md).
