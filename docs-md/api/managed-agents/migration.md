...
| `permission_mode`, `can_use_tool`                               | Per-tool [`permission_policy`](permission-policies.md) (`always_allow`, `always_ask`, or `auto`); send `user.tool_confirmation` events for calls that pause for your approval.                                                |
