...
For complete parameter details and response schemas, see the [Claude Code Analytics API reference](../api/beta/organization/usage_report/retrieve_claude_code.md).
