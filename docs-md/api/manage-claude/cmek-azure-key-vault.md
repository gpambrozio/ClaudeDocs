...
The key details step shows the organization tag. Add it to the key, as [the create step](cmek-azure-key-vault.md#organization-tag) describes, before you click **Add**.
