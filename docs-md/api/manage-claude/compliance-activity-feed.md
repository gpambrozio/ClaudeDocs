...
Organizations and files do not paginate: [List organizations](manage-claude/compliance-org-data.md) returns all results in one response, and files are retrieved individually by ID.
