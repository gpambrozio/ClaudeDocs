...
Inference hooks activity is recorded in your organization's [Activity Feed](manage-claude/compliance-activity-feed.md): configuration changes, denials, and requests that proceeded without inspection under your failure handling setting. Denial records carry identifiers that let you join each denial to the matching record in your own system.
...
[Inference hooks overview](manage-claude/inference-hooks.md)
