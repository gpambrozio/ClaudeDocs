...
| **Requires GitHub** | Yes, or [bundle a local repo](claude-code-on-the-web.md) via `--remote` | No | No | Only for cloud sessions |
...
### [​](#/web-setup-returns-“unknown-command”) `/web-setup` returns “Unknown command”
