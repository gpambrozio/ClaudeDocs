...
This page applies only if your plugin is listed in `claude-plugins-official` or another marketplace with one of Anthropic's [official marketplace names](security.md#official-marketplace-names). The community marketplace, `claude-community`, isn't one of them.

To publish a plugin, see [Publish and distribute a plugin](publish.md).
...
* **Yes, install**: installs the plugin at [user scope](install.md)
