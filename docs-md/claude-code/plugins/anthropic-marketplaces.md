...
If you wrote a plugin and want other people to install it, see [Publish a plugin](publish.md), which covers your own marketplace and submitting to the community marketplace.
