...
- From the CLI, sessions use your [`/remote-env` pick](#select-an-environment-from-the-cli), or fall back to your first available cloud environment. Passing `--environment <environment-id>` on a [scripted dispatch](self-hosted-environments-testing.md) overrides both for that invocation; the flag requires Claude Code v2.1.224 or later.
