...
Cloud environments apply to [cloud sessions](claude-code-on-the-web.md), which are in research preview for Pro, Max, and Team users, and for Enterprise users with [premium seats or Chat + Claude Code seats](https://support.claude.com/en/articles/11845131-use-claude-code-with-your-team-or-enterprise-plan).
...
| Plugins and marketplaces declared in your repo's `.claude/settings.json`                                                                                                                  | No                                                               | A cloud session doesn't install the plugins a repository turns on under [`enabledPlugins`](settings-reference.md#enabledplugins), including ones from the marketplaces it lists under [`extraKnownMarketplaces`](settings-reference.md#extraknownmarketplaces). Enable the plugin for your claude.ai account instead, so Claude Code loads it as a [synced plugin](plugins-reference.md#synced-plugins)                                                                                                                                                          |
...
| Plugins enabled only in your user settings                                                                                                                                                | No                                                               | User-scoped `enabledPlugins` lives in `~/.claude/settings.json` on your machine. Enable them for your claude.ai account instead, so Claude Code loads them as [synced plugins](plugins-reference.md#synced-plugins)                                                                                                                                                                                                                                                                                                                                                |
