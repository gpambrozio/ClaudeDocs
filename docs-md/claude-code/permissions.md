...
| `channelsEnabled` | Allow [channels](channels.md) for Team and Enterprise users. Unset or `false` blocks channel message delivery regardless of what users pass to `--channels` |
