...
* The [plugins](plugins.md) its settings enable, its [skills](skills.md#discovery-from-parent-and-nested-directories), and its [subagents](sub-agents.md)
