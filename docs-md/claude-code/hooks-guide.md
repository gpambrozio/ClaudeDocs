...
For example, malicious hooks code can exfiltrate your data. Always review your hooks implementation before registering them.For full security best practices, see [Security Considerations](hooks.md) in the hooks reference documentation.
...
### [​](#step-1:-open-hooks-configuration) Step 1: Open hooks configuration
...
### [​](#step-2:-add-a-matcher) Step 2: Add a matcher
...
### [​](#step-3:-add-the-hook) Step 3: Add the hook
...
### [​](#step-4:-save-your-configuration) Step 4: Save your configuration
...
### [​](#step-5:-verify-your-hook) Step 5: Verify your hook
...
### [​](#step-6:-test-your-hook) Step 6: Test your hook
