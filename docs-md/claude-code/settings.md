...
| `availableModels` | Restrict which models users can select for the main session, [subagents](sub-agents.md), and the [advisor](advisor.md). Does not affect the Default option. See [Restrict model selection](model-config.md) | `["sonnet", "haiku"]` |
