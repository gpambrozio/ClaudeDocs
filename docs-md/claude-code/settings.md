...
- **Managed settings**: Claude Code keeps enforcing the rest of the file. [Invalid entries in managed settings](managed-settings.md) says what it drops and which keys fall back to a stricter value until you fix them.
