...
| `inputNeededNotifEnabled` | **Default**: `false`. When [Remote Control](remote-control.md) is connected, send a push notification to your phone when a permission prompt or question is waiting for your input. Appears in `/config` as **Push when actions required**. See [Mobile push notifications](remote-control.md). Requires Claude Code v2.1.119 or later | `true` |
