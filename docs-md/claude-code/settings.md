...
~/.claude/settings.jsonacme-app/.claude/settings.jsonacme-app/.claude/settings.local.jsonManaged settings

⛶

Your machineA teammate’s machineA cloud session
...
their clone, once you commit the file

settings.json

acme-app/

fresh clone, once you commit the file
