...
Agents shipped in a [plugin](plugins/components.md#agents) honor a subset of the subagent fields.
...
| `projects/<project>/<session>/tool-results/`                                                                                    | Large tool outputs spilled to separate files, and full-size copies of [images that MCP tools return](mcp.md#images-in-tool-results)                                                                                                                                                                                                    |
...
| `skills/.trash/`, `plugins/.trash/`                                                                                             | [Skills](skills.md#how-synced-skills-behave) and [plugins](plugins/loading.md#synced-plugins) that the claude.ai sync removed, such as after you turn one off on claude.ai or stop syncing. The files stay here so you can recover them until the sweep deletes them                                                                  |
...
* [`enableArtifact`](settings-reference.md#enableartifact) isn't set to `false`
...
| `~/.claude/skills/.trash/`, `~/.claude/plugins/.trash/`                                                              | The chance to recover [synced skills](skills.md#how-synced-skills-behave) and [synced plugins](plugins/loading.md#synced-plugins) that Claude Code removed |
