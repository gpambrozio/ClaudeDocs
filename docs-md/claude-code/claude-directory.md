...
| `skills/.trash/`, `plugins/.trash/`                                                                                             | [Skills](skills.md#how-synced-skills-behave) and [plugins](plugins-reference.md#synced-plugins) synced from claude.ai that Claude Code removed. Moved here instead of deleted so you can recover the files                                                                                         |
