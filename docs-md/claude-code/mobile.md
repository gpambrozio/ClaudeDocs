...
| --- | --- | --- |
| [Claude Code on the web](claude-code-on-the-web.md) | A cloud session on Anthropic-managed infrastructure | Your repository is on GitHub and the task should keep running after you put your phone away. See the [web quickstart](web-quickstart.md) to set up. |
