...
For a fuller comparison, see [work when you are away from your terminal](platforms.md).
Cloud sessions and Remote Control run from the **Code** tab. For Dispatch, which you message as a task in the app, see [sessions from Dispatch](desktop.md).
