...
* **As a deterministic gate**: a [Stop hook](hooks.md#stop) runs your check as a script and blocks the turn from ending until it passes. [Stop input](hooks.md#stop-input) covers the cap on consecutive blocks.
