...
| `allowedHttpHookUrls`         | Claude Code enforces an empty [allowlist](settings-reference.md#allowedhttphookurls) until you fix the value. If only an individual entry is invalid, it strips that entry and enforces the rest.                                                                                                                                                                                                                       |
| `httpHookAllowedEnvVars`      | Claude Code enforces an empty [allowlist](settings-reference.md#httphookallowedenvvars) until you fix the value. If only an individual entry is invalid, it strips that entry and enforces the rest.                                                                                                                                                                                                                    |
