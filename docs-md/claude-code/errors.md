...
- In [non-interactive mode](headless.md) (`-p`):
  ...
  - To continue the turn, resume the session and send `continue` as described in [Continue conversations](headless.md).
...
- If your network lets Claude Code reach the artifact host directly, add `.claudeusercontent.com` to [`NO_PROXY`](network-config.md).
