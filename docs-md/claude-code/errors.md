...
These errors come from the [install script](setup.md) before Claude Code has started. For `command not found`, PATH, permission, and TLS problems during setup, see [Troubleshoot installation and login](troubleshoot-install.md).
