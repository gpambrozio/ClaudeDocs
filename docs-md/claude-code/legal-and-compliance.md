...
### [​](#can-customers-offer-claude-code-in-their-products) Can customers offer Claude Code in their products?
...
If a customer has executed a Business Associate Agreement (BAA) with Anthropic and has [Zero Data Retention (ZDR)](zero-data-retention.md) enabled for the relevant organization, that BAA extends to the customer’s API traffic through Claude Code.
