...
| `github.com`                         | Cloning GitHub-hosted [plugin marketplaces](plugins/overview.md) and plugins, including the official Anthropic marketplace, over HTTPS or SSH. To clone GitHub `owner/repo` sources over HTTPS only, set [`CLAUDE_CODE_PLUGIN_PREFER_HTTPS=1`](env-vars.md)                                                                                                                                                                                                                                                                                                                                    |
