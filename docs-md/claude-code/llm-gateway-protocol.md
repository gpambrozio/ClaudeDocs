...
On Claude Code v2.1.227 or later, your organization can keep [MCP tool search](mcp.md) on under this variable through [managed settings](settings.md). What Claude Code sends with that override in place depends on how you connect:
