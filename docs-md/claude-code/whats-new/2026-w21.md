...
Releases [v2.1.143 → v2.1.149](changelog.md)1 feature · May 18–22
...
[Auto mode requirements](permission-modes.md)

Other wins

[`/usage`](costs.md) now shows a per-category breakdown of what’s driving your plan limits, attributing recent usage to skills, subagents, plugins, and individual MCP servers
