...
Releases [v2.1.178 → v2.1.183](changelog.md)3 features · June 15–19
...
[Create an artifact](artifacts.md)
...
[Match by input parameter](permissions.md)
...
Fixed prompt caching not reading on a custom `ANTHROPIC_BASE_URL` and on Microsoft Foundry
