...
Releases [v2.1.150 → v2.1.157](/en/changelog#2-1-150)4 features · May 25–29
...
[Model configuration](/en/model-config#available-models)
...
[Security guidance plugin](/en/security-guidance)
...
[Fast mode pricing](/en/fast-mode#understand-the-cost-tradeoff)
