...
Releases [v2.1.92 → v2.1.101](/en/changelog#2-1-92)4 features · April 6–10
...
[Monitor tool reference](/en/tools-reference#monitor-tool)
...
[Commands reference](/en/commands)
...
Guided [Bedrock](/en/amazon-bedrock) and [Vertex AI](/en/google-vertex-ai) setup wizards on the login screen: pick “3rd-party platform” for step-by-step auth, region, credential check, and model pinning
