...
[local project level](settings.md).
...
### [​](#output-styles-vs-agents) Output Styles vs. [Agents](sub-agents.md)

Use an output style to change how the main conversation responds in every
session. Use a [subagent](sub-agents.md) when you want a separately scoped
...
### [​](#output-styles-vs-skills) Output Styles vs. [Skills](skills.md)
