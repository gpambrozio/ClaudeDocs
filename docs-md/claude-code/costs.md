...
### [​](#set-a-spend-limit-on-pro-and-max) Set a spend limit on Pro and Max
...
- **Use plan mode for complex tasks**: Press Shift+Tab to enter [plan mode](permission-modes.md) before implementation. Claude explores the codebase and proposes an approach for your approval, preventing expensive re-work when the initial direction is wrong.
