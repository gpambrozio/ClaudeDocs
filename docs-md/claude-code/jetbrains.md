...
WSL users may need additional configuration for IDE detection to work properly. See our [WSL troubleshooting guide](troubleshooting.md) for detailed setup instructions.
...
- For WSL users, see the [WSL troubleshooting guide](troubleshooting.md)
