...
To make the configuration apply everywhere Claude Code runs without depending on your shell, set the variables in the `env` block of a [settings file](settings.md). Settings files have different scopes:
