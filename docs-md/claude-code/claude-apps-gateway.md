...
| Standard prompt caching                                                                                                    | Available             | The gateway forwards `cache_control` breakpoints to every upstream, and the CLI marks the [system context it appends mid-conversation](prompt-caching.md#where-the-cache-lives) for caching on gateway sessions, as it does on every other provider and connection.                                                                                                                                                                                            |
