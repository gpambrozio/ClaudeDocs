...
| `--dangerously-skip-permissions` | Skip permission prompts. Equivalent to `--permission-mode bypassPermissions`. See [permission modes](permission-modes.md) for what this does and does not skip | `claude --dangerously-skip-permissions` |
