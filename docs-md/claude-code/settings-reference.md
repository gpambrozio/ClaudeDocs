...
| [`bashEditDiffEnabled`](#basheditdiffenabled)                                                         | Record the [files a Bash command changed](hooks.md#bash) in every permission mode                                                                                                                                          | Interface and terminal             | User or managed         |
...
Choose whether Claude Code records the files a Bash command changes in a Git repository. When it records them, you see their diff in the terminal after the command, and your [PostToolUse Bash hooks](hooks.md#bash) receive the changed-file list.
