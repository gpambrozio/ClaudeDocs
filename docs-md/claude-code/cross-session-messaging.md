...
- **Your cloud sessions**: your [Claude Code on the web](claude-code-on-the-web.md) sessions. These appear when this session has cloud access: a claude.ai login on the first-party Anthropic API and an organization policy that allows cloud sessions.
