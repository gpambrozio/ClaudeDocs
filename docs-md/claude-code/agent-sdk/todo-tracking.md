...
## [​](#when-claude-creates-todos) When Claude creates todos
...
### [​](#monitor-todo-changes) Monitor todo changes
...
### [​](#display-progress-in-real-time) Display progress in real time
