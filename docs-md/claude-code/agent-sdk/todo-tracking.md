...
Before running these examples, install the Claude Agent SDK by following the [quickstart](agent-sdk/quickstart.md).
...
See [Handle the result](agent-sdk/agent-loop.md) for the result subtypes.
