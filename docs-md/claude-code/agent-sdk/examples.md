...
## [​](#run-a-minimal-agent-first) Run a minimal agent first
...
## [​](#explore-a-typescript-application) Explore a TypeScript application
...
## [​](#work-through-a-python-recipe) Work through a Python recipe
