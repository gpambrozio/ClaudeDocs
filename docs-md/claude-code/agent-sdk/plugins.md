...
If your plugin doesn't appear in the init message's `plugins` list, check its [`plugin_errors`](typescript.md#sdksystemmessage) field for the reason, then work through these checks:
