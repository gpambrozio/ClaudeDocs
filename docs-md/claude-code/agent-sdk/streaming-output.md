...
* **Python**: [`StreamEvent`](python.md#streamevent) (import from `claude_agent_sdk.types`)
* **TypeScript**: [`SDKPartialAssistantMessage`](typescript.md#sdkpartialassistantmessage) with `type: 'stream_event'`
