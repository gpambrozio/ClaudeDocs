...
For installation, authentication, and connectivity problems, see [Troubleshooting](troubleshooting.md) instead.
...
- **[Troubleshooting](troubleshooting.md)**: `claude doctor`, platform issues, and installation problems
