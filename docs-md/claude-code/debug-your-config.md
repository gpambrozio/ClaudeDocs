...
| `/doctor` | Setup checkup: installation health, invalid settings files, unused extensions, and duplicate [subagent](sub-agents.md) names in the same directory, with proposed fixes |
