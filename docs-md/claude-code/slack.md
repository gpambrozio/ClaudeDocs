...
### [​](#”claude-code-is-not-enabled-for-your-account”) ”Claude Code is not enabled for your account”
...
If you’re an Owner or admin, recreate the environment as an [organization-shared environment](cloud-environments.md) from the **Cloud environments** page in [admin settings](https://claude.ai/admin-settings). You can apply it in two ways:
...
Organization-managed @Claude in Slack with admin-configured access](https://claude.com/docs/claude-tag/overview)
