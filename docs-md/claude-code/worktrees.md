...
All three apply whether you create the worktree with `--worktree`, with `git worktree add`, or through the [desktop app](desktop.md#work-in-parallel-with-sessions).
