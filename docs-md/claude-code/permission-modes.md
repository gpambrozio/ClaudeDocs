...
The `--dangerously-skip-permissions` flag is equivalent. Claude Code refuses `bypassPermissions` in a session you start with [`--restricted`](cli-reference.md). `--restricted` requires Claude Code v2.1.248 or later.
