...
- [Claude Code CLI](quickstart.md) version 2.0.73 or higher
...
Chrome integration requires a recent version of Claude Code. If you installed using the [native installer](quickstart.md), updates happen automatically. Otherwise, run:
