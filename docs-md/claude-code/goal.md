...
To change the intervals, set [`CLAUDE_CODE_GOAL_CHECKIN_MINUTES`](env-vars.md). Claude Code uses your value in place of the 30-minute interval and scales the idle intervals with it. Set it to `0` to turn check-ins off. Check-ins require Claude Code v2.1.234 or later.
