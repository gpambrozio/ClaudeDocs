...
Enable it with the `/sandbox` command. The [Sandboxing](sandboxing.md) guide covers the approval modes, the default boundary, and how to widen or narrow it.
