...
★ Start hereUnderstandPlanPrototypeBuildTestRefactorReviewSteerDebugGitReleaseDataAutomateProductDesignDocsMarketingSecurityOn-callClear5 prompts

Five prompts to try first

Get oriented in a new repositoryStart here · 1`give me an overview of this codebase: architecture, key directories, and how the pieces connect`

Find where something happensStart here · 2`where do we validate uploaded file types?`

Find and fix a failing testStart here · 3`the UserAuth test is failing, find out why and fix it`

Write tests, run them, fix failuresStart here · 4`write tests for app/parsers/feed.py, run them, and fix any failures`

Review your changes before you commitStart here · 5`review my uncommitted changes and flag anything that looks risky before I commit`
