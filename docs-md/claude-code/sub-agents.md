...
To allow nesting, set [`CLAUDE_CODE_MAX_SUBAGENT_SPAWN_DEPTH`](env-vars.md) to the number of subagent layers you want below your main conversation. For example, this entry in [`settings.json`](settings.md) allows two layers:
