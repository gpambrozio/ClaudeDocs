...
| `chat:clearScreen` | Cmd+K | Force a full screen redraw, preserving input and conversation. See [Clear the conversation](fullscreen.md) for how Cmd+K behaves on iTerm2 and Terminal.app |
