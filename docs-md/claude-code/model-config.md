...
The `[1m]` suffix enables a [1 million token context window](build-with-claude/context-windows.md) for long sessions.
...
[different pricing](about-claude/pricing.md).
