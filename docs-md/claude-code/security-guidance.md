...
User-scoped plugins do not carry into [cloud sessions](claude-code-on-the-web.md), because those sessions don't run on your machine. To enable the plugin there, or to turn it on for everyone who clones a repository, declare it in the project's checked-in settings:
