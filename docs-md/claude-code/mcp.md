...
Use this full name when referencing the tool in [permission rules](permissions.md), a skill’s `allowed-tools` list, or a [subagent’s `tools` field](sub-agents.md).
