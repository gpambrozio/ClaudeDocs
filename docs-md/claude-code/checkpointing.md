...
- Claude Code deletes checkpoints along with sessions after 30 days, following the [retention sweep rules](claude-directory.md); change the period with [`cleanupPeriodDays`](settings-reference.md)
