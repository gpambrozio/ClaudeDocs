...
- [Claude for Teams or Enterprise](setup.md) (recommended)
- [Claude Console with team billing](setup.md)
- [Amazon Bedrock](amazon-bedrock.md)
- [Google Vertex AI](google-vertex-ai.md)
- [Microsoft Foundry](microsoft-foundry.md)

### [​](#claude-for-teams-or-enterprise-recommended) Claude for Teams or Enterprise (recommended)
...
3. Users can [install Claude Code](setup.md)
