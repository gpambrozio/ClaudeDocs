...
* You or your organization set [`disableAllHooks`](settings-reference.md#disableallhooks) or [`allowManagedHooksOnly`](settings-reference.md#allowmanagedhooksonly), or you disabled the built-in `agents-md` plugin in `/plugin`
