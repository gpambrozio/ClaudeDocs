...
- Fast mode pricing is 30/30/30/150 MTok on both Opus 4.6 and Opus 4.7.
...
## [​](#use-fast-mode-on-opus-4-7) Use fast mode on Opus 4.7
...
Or in any Claude Code [settings file](settings.md), including user, project, and managed settings, to scope the opt-in:
